...
- [ ] Incorporar seletivamente os padrões aprovados do repositório comparado: centavos inteiros, neutralização de fórmulas no Excel, guardas de resposta SIGEF e publicação de visão corrente condicionada à execução completa aprovada.
