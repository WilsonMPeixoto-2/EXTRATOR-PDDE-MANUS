...
| SIGEF — Liberação de Recursos | Parcial. A tela permite parâmetros de ano, programa, CNPJ, UF e município, mas apresenta CAPTCHA. [2] | Automatizar somente passos permitidos e usar resultado apenas se houver canal institucional/documentado sem CAPTCHA. | `ACESSO_EXIGE_CAPTCHA` — bloqueio externo, sem inferência financeira. |
