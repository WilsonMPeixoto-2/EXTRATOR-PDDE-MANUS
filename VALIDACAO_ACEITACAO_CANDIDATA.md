...
Para publicar no GitHub, a decisão deve indicar o repositório privado `WilsonMPeixoto-2/sdp-4cre` como destino e confirmar que esta versão candidata foi aceita para compartilhamento de código, sem evidências brutas ou credenciais.
